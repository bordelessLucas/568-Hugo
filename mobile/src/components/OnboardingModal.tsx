...
export function OnboardingModal() {
  ...
  return (
    <Modal animationType="slide" visible presentationStyle="fullScreen">
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        >
          ...
          <View style={styles.actions}>
            ...
            />
            {form.stepIndex > 0 ? (
              <Button label="Voltar" variant="outline" disabled={form.busy} onPress={form.goBack} />
            ) : null}
            <Button
...
function Choice({
  ...
  return (
    ...
    >
      ...
      {selected ? <Icon name="checkmark-circle" size={22} color={tokens.color.brand} /> : null}
    </Pressable>
  )
}
